  ...
  return (
    <main className={styles.page}>
      <div className={styles.shell}>
        <TopNav title="My bookings" subtitle="Reschedule or cancel tickets" />
        ...
        <div className={styles.hero}>
          ...
          <div className={styles.statStrip}>
            <div className={styles.statCard}>
              ...
              <div className={styles.mutedSmall}>Loaded for demo</div>
            </div>
            <div className={styles.statCard}>
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              <div className={styles.sectionHeader}>
                <div>
                  <div className={styles.cardTitle}>Your tickets</div>
              ...
              <div className={styles.list}>
                {bookings.map((booking) => (
                  <div key={booking.ticketId} className={styles.park}>
                    <div className={styles.sectionHeader}>
                      <div>
                        <div className={styles.ticketTitle}>Ticket #{booking.ticketId}</div>
                        <div className={styles.tinyLabel}>
                          {booking.parkName} · {new Date(booking.visitDate).toLocaleDateString()}
                        </div>
